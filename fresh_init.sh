#!/bin/bash
    ...
    apt install screen fonts-powerline tmux vim htop chromium-browser zsh g++ lcov git libmagickcore-dev libusb-1.0.0-dev libnss3-dev libglib2.0-dev libtool fprintd automake python python3 python-pip npm doxygen inkscape sl cmatrix
    #updategit@github.com:solsane/configs.git
